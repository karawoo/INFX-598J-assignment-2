...
```{r data_versions}
## Here are some alternate versions of the data to be used below
...
```{r scatterplot_by_year, fig.height = 15}
...
```{r scatterplot_by_year_labeled, fig.height = 15}
